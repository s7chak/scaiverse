				...
				{/* <div className="columns">
					<div className="column is-10"> */}
						<motion.div className="about-description"
							...
							<br />
							<span>Here is the latest tech-stack I am working with.</span>
						</motion.div>
						<div
							...
							<div className="column is-3">
								<div className="box">
									<img src="./files/pylogo.png" alt="" style={{'height':'25px'}}/><span>Python</span>
								</div>
							</div>
							<div className="column is-3">
								<div className="box">
							...
							<div className="column is-3">
								<div className="box">
									<img src="./files/c.png" alt="" style={{'height':'25px'}}/>
									<span>C#</span>
								</div>
							</div>
							<div className="column is-3">
